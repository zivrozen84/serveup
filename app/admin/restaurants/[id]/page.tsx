...
export default async function RestaurantEditPage({
  ...
  const formInitialData = {
    ...
    flyingDiscVisibility: (restaurant as { flyingDiscVisibility?: number | null }).flyingDiscVisibility ?? null,
      ...
      summaryTabPrimaryColor: (restaurant as { summaryTabPrimaryColor?: string | null }).summaryTabPrimaryColor ?? null,
      summaryTabSecondaryColor: (restaurant as { summaryTabSecondaryColor?: string | null }).summaryTabSecondaryColor ?? null,
      summarySubmitButtonColor: (restaurant as { summarySubmitButtonColor?: string | null }).summarySubmitButtonColor ?? null,
      menuDisplayFormat: restaurant.menuDisplayFormat ?? "large",
      isActive: restaurant.isActive,
    openTime: (restaurant as { openTime?: string | null }).openTime ?? null,
    closeTime: (restaurant as { closeTime?: string | null }).closeTime ?? null,
    logoUrl: restaurant.logoUrl,
    bannerUrl: restaurant.bannerUrl,
    backgroundUrl: restaurant.backgroundUrl,
    frameUrl: restaurant.frameUrl,
